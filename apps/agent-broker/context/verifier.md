...
Never read Nextcloud database credentials or query MariaDB/MySQL directly. Use TLS application APIs or the semantic Nextcloud helper status modes; if those are unavailable, report a verification limitation instead of bypassing the administration boundary.
