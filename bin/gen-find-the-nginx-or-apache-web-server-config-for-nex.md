# Find the nginx or apache web server config for nextcloudwej
> Generated 2026-07-11T11:36:36.640Z

## Prompt
Find the nginx or apache web server config for nextcloud.wejos.de on this host. Check /etc/nginx/sites-enabled/ and /etc/apache2/sites-enabled/ for the virtual host that serves nextcloud.wejos.de. Show me the full config file path and its content, especially any existing proxy_pass or location blocks.
