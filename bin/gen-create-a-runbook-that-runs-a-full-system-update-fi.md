# Create a runbook that runs a full system update First check
> Generated 2026-07-11T13:48:46.671Z

## Prompt
Create a runbook that runs a full system update. First check if apt is available, then run: apt-get update -qq && apt-get upgrade -y. After the update, show a summary of what was upgraded (look at /var/log/apt/history.log for the last entry).
