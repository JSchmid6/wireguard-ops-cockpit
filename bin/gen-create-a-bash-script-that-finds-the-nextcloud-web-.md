# Create a bash script that finds the nextcloud web server con
> Generated 2026-07-11T13:40:41.928Z

## Prompt
Create a bash script that finds the nextcloud web server config. Run: ls /etc/nginx/sites-enabled/ 2>&1; ls /etc/apache2/sites-enabled/ 2>&1; then cat any config file that mentions nextcloud.wejos.de. Output the file path and full content.
