# Check if there is an exapps location block in the nginx or
> Generated 2026-07-11T19:07:32.980Z

## Prompt
Check if there is an /exapps/ location block in the nginx or apache config for nextcloud.wejos.de. Look in /etc/nginx/sites-enabled/ and /etc/apache2/sites-enabled/. Cat the config file that contains nextcloud.wejos.de and report whether /exapps/ is already configured.
