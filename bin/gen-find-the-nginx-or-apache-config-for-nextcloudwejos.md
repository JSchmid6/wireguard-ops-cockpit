# Find the nginx or apache config for nextcloudwejosde List
> Generated 2026-07-11T19:36:20.527Z

## Prompt
Find the nginx or apache config for nextcloud.wejos.de. List /etc/nginx/sites-enabled/ and cat the file that contains nextcloud.wejos.de. Check if there is a location /exapps/ block already. Output the config file name and whether /exapps/ is present.
