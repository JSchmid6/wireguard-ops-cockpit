...
- Use `quality-engineer` for test strategy, coverage work, and CI quality gates.
- Use `platform-delivery` for Docker Compose delivery, CI/CD, and deployment-readiness work.
